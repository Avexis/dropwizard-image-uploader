...
class BasicImageTransformerTest {
    ...
    void toBufferedImage_TransformByWidth() throws ImageStorerException {
    ...
    @Test
    @DisplayName("TransformBufferdImage")
    void toBufferedImage_TransformByHeight() throws ImageStorerException {
    ...
    void toBufferedImage_transformCrop() throws ImageStorerException {
    ...
    @Test
    void toBase64() throws ImageStorerException {
